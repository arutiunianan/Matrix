...
class DimensionMismatch : public MatrixException {
   public:
    explicit DimensionMismatch() : MatrixException("\n Dimension Mismatch") {}
};

class DevisionByZero : public MatrixException {
   public:
    explicit DevisionByZero() : MatrixException("\n Division by Zero") {}
};

class NonSquareMatrix : public MatrixException {
   public:
    explicit NonSquareMatrix() : MatrixException("\n Non-Square Matrix") {}
};

class DeterminantIsZero : public MatrixException {
   public:
    explicit DeterminantIsZero() : MatrixException("\n Determinant is Zero") {}
};
